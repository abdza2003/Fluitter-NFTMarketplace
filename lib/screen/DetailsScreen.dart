...
class DetailsScreen extends StatefulWidget {
  ...
  @override
  State<DetailsScreen> createState() => _descriptionPageState();
}

class _descriptionPageState extends State<DetailsScreen> {
  var top = 0.0;
  var top2 = 400.0;
  var top3 = 0.0;
                  ...
                  title: AnimatedOpacity(
                    ...
                    child: Container(
                      ...
                      child: CachedNetworkImage(
                        fit: BoxFit.cover,
                        imageUrl: (widget.image_url_items),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AnimatedContainer(
                                ...
                                width: 300,
                                height: isClickmore &&
                                        widget.description.toString().length >=
                                            35
                                    ? widget.description
                                            .toString()
                                            .length
                                        ...
                                        widget.description
                                                ...
                                                .toDouble() /
                                            10
                                    : widget.description.toString().length >= 35
                                        ? widget.description
                                                .toString()
                                                .length
                                                .toDouble() -
                              ...
                              if (widget.description.toString().length >= 35)
                                GestureDetector(
                                  onTap: () {
                                    setState(() {
