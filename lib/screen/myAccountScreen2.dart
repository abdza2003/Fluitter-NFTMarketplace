...
class myAccountScreen2 extends StatefulWidget {
  var idKey;
  var idKey2;
  myAccountScreen2({required this.idKey, required this.idKey2});
  @override
  State<myAccountScreen2> createState() => _myAccount2ScreenState();
}

class _myAccount2ScreenState extends State<myAccountScreen2> {
  double top = 0.0;
  String yourBio = '';
  double top2 = 200;
  String name =
    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        stream: FirebaseFirestore.instance
            .collection('/newAccount/${widget.idKey2}/user/')
            .snapshots(),
